...
- Recent changes: !`tail -20 /home/wtyler/.claude/history.jsonl 2>/dev/null || echo "No history available"`
- Repository info: !`pwd`
...
Remember to be constructive and provide specific examples with file paths and line numbers where applicable. Save a copy of full output to docs folder.